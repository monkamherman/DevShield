...
help:
	...
	@printf '%s\n' '  provenance-generate Generate CI provenance from real build and Harbor evidence' '  provenance-attest Sign the provenance as a Cosign OCI attestation' '  provenance-verify Verify a digest-bound Cosign provenance attestation' '  test-provenance Run provenance positive and negative tests'
...
provenance-generate:
	@security/provenance/generate.sh

provenance-attest:
	@security/provenance/attest.sh $(IMAGE_REF)

provenance-verify:
	@security/provenance/verify.sh --artifact "$(IMAGE_REF)"

test-provenance:
	@tests/security/provenance/run.sh
...
deployment-adapter-test:
	@tests/security/deployment/adapter.sh

deployment-security: deployment-test deployment-adapter-test
...
observability-validate:
	@security/observability/validate.sh

observability-test:
	@tests/security/observability/run.sh

observability-security: observability-test

observability-healthcheck:
	@security/observability/healthcheck.sh
