...
Security scanning, artifact creation and optional Harbor publication are now implemented in the dedicated security workflow. Signing, provenance, policy verification with OPA/Rego and deployment remain deferred to later phases. A successful foundation workflow must not be interpreted as a security approval.
